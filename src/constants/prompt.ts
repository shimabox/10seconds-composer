...
\`\`\`
※ このjsonでのコード進行はあくまでも例なので、あなたのイメージに合わせて変更してください
4. startTimeのバーとビートは曲の進行に応じた適切なバーとビートを指定してください
5. chordは色々な和音で指定してください(三和音、四和音、もっと複雑な和音でもよいです。適切に組み合わせてください。)
6. ただし、chordの配列の中には "Am7"、"Dm7"、"F/G" のようなコード名や和音記号は一切入れないでください。
   各要素は必ず "C4", "E4", "G4" のような有効な音名（音名＋オクターブ）で指定してください。
   例: 正しくは ["A3", "C4", "E4", "G4"] としてください。
